module.exports = {
  ...
  DISABLE_BUZZER  : Buffer.from([0x1d, 0x2b, 0x04, 0x00, 0x05, 0x77, 0x00, 0x00]), // Disable external buzzer

  // Cash Drawer
  CD_KICK_2 : Buffer.from([0x1b, 0x70, 0x00, 0x32, 0xfa]),      // Sends a pulse to pin 2 []
  CD_KICK_5 : Buffer.from([0x1b, 0x70, 0x01, 0x32, 0xfa]),      // Sends a pulse to pin 5 []
